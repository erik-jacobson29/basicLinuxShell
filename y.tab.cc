...
{
       0,    49,    49,    53,    54,    57,    61,    65,    66,    70,
      76,    77,    81,    82,    86,    97,   109,   114,   118,   119,
     122,   127,   132,   138,   142,   146
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREATGREAT", "AMPERSAND", "GREATAMPERSAND", "PIPE", "LESS", "TWOGREAT",
  "GREATGREATAMPERSAND", "$accept", "goal", "commands", "command",
  "simple_command", "command_and_args", "pipe_list", "argument_list",
  "argument", "command_word", "background", "io_modifier_list",
...
static const yytype_int8 yystos[] =
{
      ...
      23,     6,     0,    17,    10,    25,    21,    19,     5,     7,
       8,     9,    11,    12,    13,    24,    26,     3,    22,     3,
       3,     3,     3,     3,     3,     6
};
...
#line 86 "shell.y"
    ...
    //printf("here\n");
    Command::_currentSimpleCommand->expandWildcardsIfNecessary( (yyvsp[0].cpp_string)->c_str() );
